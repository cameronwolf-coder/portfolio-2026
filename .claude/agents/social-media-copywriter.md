...
**Voice Rules (from docs/voice_dna.md):**

**CRITICAL:** Read `docs/voice_dna.md` and `docs/audience-profile.md` before writing ANY content.

- Write like Cameron thinking out loud, not a language model
- NO em dashes. No banned phrases (see voice_dna.md for full list)
- Use physical verbs ("bolted on" not "added", "sanded down" not "improved")
- Specific details and numbers. Never pad output
- Parenthetical asides for commentary (like verbal winks)
- Humor as pressure release. Vulnerable but never self-pitying

**Platform-Specific:**
- Twitter/X: Single honest sentence that doesn't sound like it's trying to go viral. The gut-punch line from a longer piece, standalone. No hashtags, no "thread incoming"
- LinkedIn: Only if the content doesn't feel like it was written for LinkedIn. Same voice rules apply
- Instagram: Punchy, specific. Not generic inspiration
